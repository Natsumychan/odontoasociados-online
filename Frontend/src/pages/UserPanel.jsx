						...
						{[
							{
								...
								desc: "No olvide tomar su medicación antiinflamatoria durante 3 días más.",
							},
							{
								icon: (
									<img
								...
								desc: "Recuerde cepillar sus dientes después de cada comida y usar hilo dental diariamente.",
							},
							{
								icon: <Calendar className='text-green-500' />,
								title: "Próxima revisión de ortodoncia",
								desc: "Su próximo ajuste de ortodoncia debe programarse para julio.",
							},
						].map((item, i) => (
							<li
								key={i}
